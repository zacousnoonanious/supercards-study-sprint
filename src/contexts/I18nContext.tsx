...
const translations = {
  ...
  zh: {
    ...
    // Decks specific
    'decks.title': '我的卡组',
    'decks.createNew': '创建新卡组',
    'decks.noDecks': '暂无卡组',
    'decks.noDecksDesc': '创建您的第一个闪卡卡组开始学习！',
    'decks.createFirst': '创建您的第一个卡组',
    'decks.viewCards': '查看卡片',
    'decks.study': '学习',
    'decks.edit': '编辑',
    'decks.delete': '删除',
    'decks.deleteConfirm': '删除卡组',
    'decks.deleteMessage': '您确定要删除"{title}"吗？此操作无法撤销，将永久删除此卡组中的所有卡片。',
    'decks.deleteSuccess': '卡组"{title}"删除成功。',
    'decks.deleteError': '删除卡组失败。请重试。',
    'decks.loadError': '加载您的闪卡卡组失败。',
    ...
    'dashboard.subtitle': '这里是您的学习进度概览。',
    'dashboard.totalCards': '总卡片数',
    'dashboard.studyStreak': '学习连续天数',
    'dashboard.cardsReviewed': '已复习卡片',
    'dashboard.days': '天',
    ...
    'dashboard.createNewDeck': '创建新卡组',
    'dashboard.browseDecks': '浏览我的卡组',
